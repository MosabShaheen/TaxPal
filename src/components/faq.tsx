                ...
                <ul role='list' className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3">
                    <li>
                        <ul role='list' className="flex flex-col gap-y-8">
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>Does TaxPal handle VAT</h3>
                            ...
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>Can I pay for my subscription via purchase order?</h3>
                                <p className={`${inter.className} mt-4 text-sm text-slate-700`}>Absolutely, we are happy to take your money in all forms.</p>
                            </li>
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>How do I apply for a job at TaxPal?</h3>
                    ...
                    <li>
                        <ul role='list' className="flex flex-col gap-y-8">
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>What was that testimonial about tax fraud all about?</h3>
                            ...
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>TaxPal sounds horrible but why do I still feel compelled to purchase?</h3>
                            ...
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>I found other companies called TaxPal, are you sure you can use this name?</h3>
                    ...
                    <ul role='list' className="flex flex-col gap-y-8">
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>How do you generate reports?</h3>
                            ...
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>Can we expect more inventory features?</h3>
                                <p className={`${inter.className} mt-4 text-sm text-slate-700`}>{`In life it’s really better to never expect anything at all.`}</p>
                            </li>
                            <li>
                                <h3 className={`${lexend.className} text-lg leading-7 text-slate-900`}>I lost my password, how do I get into my account?</h3>
