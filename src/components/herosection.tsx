  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
        <h1
          className={`${lexend.className} mx-auto max-w-4xl text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl`}
        >
          Accounting
        ...
        <p
          className={`${inter.className} leading-8 mx-auto mt-7 max-w-screen-sm text-lg tracking-tight text-slate-700`}
        >
          {`Most bookkeeping software is accurate, but hard to use. We make the
          opposite trade-off, and hope you don't get audited.`}
        </p>
        <div className={`${inter.className} mt-10 flex justify-center gap-x-6`}>
          <Link
        ...
        <div className="mt-36 lg:mt-44">
          <p className={`${lexend.className} text-base text-slate-900`}>
